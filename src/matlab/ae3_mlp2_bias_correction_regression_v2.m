...
for i=1:max_epoch_p
  for j=1:num_of_train
      ...
      w_e1=w_e1-eta_e*e*-1*1*((w2*f_driviate)*(w1*f_driviate_e3)*(w_e3*f_driviate_e2)*(w_e2*f_driviate_e1))'*input; 
      w_e2=w_e2-eta_e*e*-1*1*((w2*f_driviate)*(w1*f_driviate_e3)*(w_e3*f_driviate_e2))'*h1';
      w_e3=w_e3-eta_e*e*-1*1*((w2*f_driviate)*(w1*f_driviate_e3))'*h2'; 
       
      % Back Propagation 
      w1=w1-eta_p*e*-1*1*(w2*f_driviate)'*h3';  
