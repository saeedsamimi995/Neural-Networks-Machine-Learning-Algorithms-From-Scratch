...
for i=1:max_epoch_p
  for j=1:num_of_train
      ...
      w_e1=w_e1-eta_e*(e'*((w2*f_driviate)*(w1*f_driviate_e3)*(w_e3*f_driviate_e2)*(w_e2*f_driviate_e1)))'*input; 
      w_e2=w_e2-eta_e*(e'*((w2*f_driviate)*(w1*f_driviate_e3)*(w_e3*f_driviate_e2)))'*h1';
      w_e3=w_e3-eta_e*(e'*((w2*f_driviate)*(w1*f_driviate_e3)))'*h2'; 
      % Back Propagation
      f_driviate=diag(o1.*(1-o1)); 
